#
#  Be sure to run `pod spec lint ToneAudioKitEx.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/Anilkumar18/AudioKitEx"
  spec.license      = { :type => "MIT", :file => "LICENSE" }
  spec.author       = { "Venkatesh S" => "anilkumarunni@gmail.com" }
  spec.source       = { :git => "https://github.com/Anilkumar18/AudioKitEx.git", :tag => spec.version.to_s }
  spec.ios.deployment_target = '12.0'
  spec.ios.vendored_frameworks = "AudioKitEX.xcframework"
